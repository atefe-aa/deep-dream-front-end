import { BarChartTotalsNumber, BarChartTotalsPrice, TestTypeNumberSeries, TestTypePriceSeries, radarNumberSeries, radarPriceSeries, testNumberSeries, testPriceSeries, xaxisCategories, xaxisTestTypeCategories } from "../../utils/constants";
import { BarChart } from "./components/BarChart";
import { LineChart } from "./components/LineChart";
import { RadarChart } from "./components/RadarChart";

export function Statistics () {
    return <div className="row gy-5 g-xxl-8">
    {/* begin::Col */}
