  ...
  useEffect(() => {
    if (!isLoading && testType) {
      formik.setValues({
        ...
        step: testType.step || "" as unknown as number,
        microStep: testType.microStep || "" as unknown as number,
        z: testType.z || "" as unknown as number,
        brightness: testType.brightness || "" as unknown as number,
        condenser: testType.condenser || "" as unknown as number,
